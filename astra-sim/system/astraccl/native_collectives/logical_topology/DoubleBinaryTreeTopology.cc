...
DoubleBinaryTreeTopology::DoubleBinaryTreeTopology(int id, 
                                                   std::vector<int> involved_NPUs){
    DBMAX = new BinaryTree(id, BinaryTree::TreeType::RootMax, involved_NPUs);
    DBMIN = new BinaryTree(id, BinaryTree::TreeType::RootMin, involved_NPUs);
    this->counter = 0;
}
...
DoubleBinaryTreeTopology::DoubleBinaryTreeTopology(int id,
                                                   ...
                                                   int start,
                                                   int stride) {
    DBMAX = new BinaryTree(id, BinaryTree::TreeType::RootMax, total_tree_nodes,
                           start, stride);
    DBMIN = new BinaryTree(id, BinaryTree::TreeType::RootMin, total_tree_nodes,
                           start, stride);
    this->counter = 0;
}
